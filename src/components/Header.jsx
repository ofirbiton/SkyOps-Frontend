  ...
  const sendMission = async () => {
    ...
    try {
      ...
      navigate("/mission-result", {
        state: {
          imageUrl: "http://skyops-backend-production.up.railway.app/api/create-mission" + result.satelliteImageUrl,
          textFileUrl: "http://skyops-backend-production.up.railway.app/api/create-mission" + result.coordinatesFileUrl,
        }
      });
