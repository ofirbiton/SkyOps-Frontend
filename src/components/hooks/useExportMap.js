...
export function useExportMap(setOrthoImageUrl, setStreetsImageUrl, setClickStage) {
  const exportMapImage = useCallback(({ x1, y1, x2, y2 }) => {
  ...
  }, [setOrthoImageUrl, setStreetsImageUrl, setClickStage]);
